...
SECRET_KEY = 'django-insecure-d79ca64%!)u&n1ld=p-*#u(jy$i1cyg13t1grra=rp_9zh!x*k'
...
# Custom user model
AUTH_USER_MODEL = 'users.CompanyAdmin'
...
MIDDLEWARE = [
    ...
    'users.middleware.RequestMiddleware',  # Our custom middleware
]
